...
namespace Illuminate\Http {
    ...
    class Request {
         ...
         * 
         *
         * @see \MoonShine\Laravel\Providers\MoonShineServiceProvider::registerMacros()
         * @param string $key
         * @param mixed|null $default
         * @return mixed|null 
         * @static 
         */
        public static function getScalar($key, $default = null)
        {
            return \Illuminate\Http\Request::getScalar($key, $default);
        }
...
namespace MoonShine\Core\Pages {
    ...
    class Pages {
        ...
        public static function downloadExcel($fileName, $writerType = null, $withHeadings = false, $responseHeaders = [])
        {
            return \MoonShine\Core\Pages\Pages::downloadExcel($fileName, $writerType, $withHeadings, $responseHeaders);
        }
        ...
        public static function storeExcel($filePath, $disk = null, $writerType = null, $withHeadings = false)
        {
            return \MoonShine\Core\Pages\Pages::storeExcel($filePath, $disk, $writerType, $withHeadings);
        }
...
namespace Illuminate\Routing {
    ...
    class Router {
         ...
         * @param bool $withPage
         * @param bool $withAuthenticate
         * @static 
         */
        public static function moonshine($callback, $withResource = false, $withPage = false, $withAuthenticate = false)
        {
            return \Illuminate\Routing\Router::moonshine($callback, $withResource, $withPage, $withAuthenticate);
        }
