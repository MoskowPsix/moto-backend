...
{
    public function __invoke(int $id, ToogleAppointmentRaceRequest $request): ManyDocumentAppointmentRaceResource|SuccessCreateAppointmentRaceResource | NotFoundResource | SuccessDeleteAppointmentRaceResource;
}
