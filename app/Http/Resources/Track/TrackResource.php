 ...
 * @property mixed requisites_file
 * @property mixed offer_file
 */
class TrackResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'images'        => $this->images,
            'latitude'      => !empty(json_decode($this->point)->coordinates) ? json_decode($this->point)->coordinates[1] : 0,
            'longitude'     => !empty(json_decode($this->point)->coordinates) ? json_decode($this->point)->coordinates[0] : 0,
            ...
            'attendance'    => $this->whenLoaded('attendance', AttendanceResource::collection($this->attendance)),
            'requisites'    => $this->requisites_file,
            'offer'         => $this->offer_file,
        ];
    }
}
